...
constexpr int MAX_QUEUED_SAMPLES = (int)(SAMPLE_RATE / 2); // 1/2 seconds
...
#define CPU_ADDR_SPACE_CARTRIDGE_PRG_RAM_START 0x6000
#define CPU_ADDR_SPACE_CARTRIDGE_PRG_RAM_SIZE 0x2000
#define CPU_ADDR_SPACE_CARTRIDGE_PRG_RAM_END (CPU_ADDR_SPACE_CARTRIDGE_PRG_RAM_START + CPU_ADDR_SPACE_CARTRIDGE_PRG_RAM_SIZE - 1)
